...
import { AssumptionsProvider } from "@/components/assumptions/AssumptionsProvider";
import "./globals.css";
      ...
      <body className="min-h-full flex flex-col bg-zinc-50 dark:bg-black">
        <ToastProvider>
          <AssumptionsProvider>
            ...
            <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-8 pb-24">{children}</main>
          </AssumptionsProvider>
        </ToastProvider>
      </body>
    </html>
